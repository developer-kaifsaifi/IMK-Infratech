...
export default function Projects() {
  return (
    <div className="w-full md:py-20 px-10 md:px-10 md:h-760 relative bg-[#ffffff]">
          <div className="bg-[url(./assets/beam.png)] bg-center bg-cover absolute top-1/7 left-1/2 md:left-[2%] md:translate-x-0 md:translate-y-0  -translate-x-1/2 -translate-y-1/2 md:top-10 md:right-10  h-30 w-30"/>
          ...
          <div className="w-full h-130 py-15  px-25 flex-wrap flex items-center justify-center md:gap-5  ">
           <Swiper
      pagination={{
          dynamicBullets: true,
        }}
    ...
    <div className='w-full gap-5 mt-10 uppercase flex items-center justify-center '><hr className='border-4 rounded-l-full font-bold w-70' /><h1 className='text-y font-extrabold text-5xl'>Garter Pilling Service</h1><hr className='border-4 w-70 rounded-r-full ' /></div>
...
<div className='mt-80 pt-10 border-t-2 border-[#FE9A00]'>
  <div className="w-full h-130 py-15  px-25 flex-wrap flex items-center justify-center md:gap-5  ">
    ...
    <div className='w-full gap-5 mt-10 uppercase flex items-center justify-center '><hr className='border-4 rounded-l-full font-bold w-65' /><h1 className='text-y font-extrabold text-5xl'>Concrete Pilling Service</h1><hr className='border-4 w-65 rounded-r-full ' /></div>
...
<div className='mt-80 pt-10 border-t-2 border-[#FE9A00]'>
  <div className="w-full h-130 py-15  px-25 flex-wrap flex items-center justify-center md:gap-5  ">
    ...
    <div className='w-full gap-5 mt-10 uppercase flex items-center justify-center '><hr className='border-4 rounded-l-full font-bold w-65' /><h1 className='text-y font-extrabold text-5xl'>Other Pilling Service</h1><hr className='border-4 w-65 rounded-r-full ' /></div>
