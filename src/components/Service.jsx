...
export default function Service() {
  return (
    ...
    <div className="w-full px-10 md:px-10 h-480 md:h-220 relative bg-[#ffffff]">
      <img src={logo} className=" bg-center bg-cover absolute top-50 left-1/2 md:left-[90%] md:translate-x-0 md:translate-y-0  -translate-x-1/2 -translate-y-1/2 md:top-10 md:right-10  h-30 w-30"/>
